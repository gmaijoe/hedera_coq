 ...
 gradient = ctx.createLinearGradient(0, 0, viewportWidth, 0);
gradient.addColorStop("0", "rgba(24, 6, 72, 0.71)");
gradient.addColorStop("0.5", "rgba(97, 0, 122, 0.68)");
gradient.addColorStop("0.1", "rgba(156, 6, 95, 0.72)");
gradient.addColorStop("0.1", "rgba(202, 24, 30, 0.62)");
